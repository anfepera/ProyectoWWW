...
//                echo $opcion;
                if($opcion==1){
                    $this->id_coleccion = $_POST['id_coleccion'];
                 ...
                 switch($opcion){
                    ...
                    case 2:
                        $contListReprod->consultar($_POST['id']);
                    break;
                    ...
                    case 4:
                        $contListReprod->modificar($_POST['id_coleccion'], $_POST['nombre'], $_POST['nombre_modif'], $_POST['r_imag_modif']);
                    break;
                    
                    case 5:
                        $contListReprod->agregarCancion($_POST['id_coleccion'], $_POST['nombre_lista'], $_POST['id_cancion']);
                    break;
                    
                    case 6:
                        $contListReprod->listarCancionesPorListaRep($_POST['id_coleccion']);
                    break;
                }
             }
